...
import { addSlide as addSlideToContainer, parseError } from './utils.ts';
...
// addSlide and parseError moved to utils.ts for testability
    ...
    for await (const chunk of result) {
      for (const candidate of chunk.candidates) {
        for (const part of candidate.content.parts ?? []) {
          ...
          if (text && img) {
            await addSlideToContainer(slideshow, text, img);
